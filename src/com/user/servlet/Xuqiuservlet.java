...
public class Xuqiuservlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(method.equals("fenleisearch"))
		{
			fenleisearch(request,response);
		}
		else 
		{
	...
	protected void fenleisearch(HttpServletRequest req,HttpServletResponse resp)throws ServletException,IOException
	{
		req.setCharacterEncoding("utf-8");
		int shendu=StringUtil.StringToInt(req.getParameter("shendu"));
		String name=req.getParameter("name");
		
		List<Zhengjibean>zhengjibeanlist=new Xuqiuservice().fenleisearch(shendu,name);
		req.setAttribute("zhengjibeanlist", zhengjibeanlist);
		req.getRequestDispatcher("/index/needsearch.jsp").forward(req, resp);
	}
	...
	protected void zhengjishenehe(HttpServletRequest req,HttpServletResponse resp)throws ServletException,IOException
	{
		...
		List<Zhengjibean>zhengjibeanlist=new Xuqiuservice().shenhe(1);
		req.setAttribute("zhengjibeanlist", zhengjibeanlist);
	...
	protected void needlist(HttpServletRequest req,HttpServletResponse resp)throws ServletException,IOException
	{
		...
		//req.setAttribute("zhengjibeanlist", zhengjibeanlist);
		req.getRequestDispatcher("/index/index3.jsp").forward(req, resp);
