...
function jianyan()
{
   ...
   var time=$("#xuqiuqianyear").val();
   var time1=$("#xuqiuhouyear").val();
   if(state==1)
	   {
...
<body>
<h3 align="center">河北省重大技术需求征集列表</h3>
	<div class="container-fluid">
		...
		<form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/admin/needsearchServlet?method=needsearch"
				target="mainAction1" method="post" id="form1">
				...
				<table class="table table-striped">
					...
					<c:forEach items="${zhengjibeanlist }" var="item"
						...
						<tr>
							<td>${item.id }</td>
							<td><a
								href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=search&id=${item.id }">${item.jishuxuqiuname }</a></td>
