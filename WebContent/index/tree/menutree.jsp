        ...
        "list": [
            {   
                ...
                "list": [
                    {
                        "name": "学科1",
                        "url" :"${pageContext.request.contextPath}/admin/needsearchServlet?method=fenleisearch&shendu=2&name=学科1",
                        "userLevel":""
                    },
                    {
                        "name": "学科2",
                        "url" :"${pageContext.request.contextPath}/admin/needsearchServlet?method=fenleisearch&shendu=2&name=学科2",
                        "userLevel":""
                    },
                    {
                        "name": "学科3",
                        "url" :"${pageContext.request.contextPath}/admin/needsearchServlet?method=fenleisearch&shendu=2&name=学科3",
                        "userLevel":""
                    },
                    {
                        "name": "学科4",
                        "url" :"${pageContext.request.contextPath}/admin/needsearchServlet?method=fenleisearch&shendu=2&name=学科4",
                        "userLevel":""
                    },
                    {
                        "name": "学科55",
                        "url" :"${pageContext.request.contextPath}/admin/needsearchServlet?method=fenleisearch&shendu=2&name=学科5",
                        "userLevel":""
                    }
                ]
            },
